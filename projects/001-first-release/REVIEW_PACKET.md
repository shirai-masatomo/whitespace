...
| 足場間の平均移動 | 通常9.64秒 / 補給直行16.45秒 / 寄り道10.07秒 |
| 完走 | 86.72 / 82.23 / 90.67秒、最低酸素25.27%以上 |
| 救助の代表例 | 90→60m、損失30m、操作復帰2.27秒。多数プレイヤーの平均ではない |
| 潮流 / クラゲ | 中心最大1.8m/sの横流れ / 接触時4.5m/sの上向き反発 |

[測定JSON](review/evaluation.json)。急降下直行は33.08秒・最低酸素32.40%、同じ急降下操縦で補給迂回は47.30秒・52.63%。潮流を通る経路は39.50秒、同じ操作の無潮流対照40.08秒。最速の全探索ではなく、比較した経路間の差。
