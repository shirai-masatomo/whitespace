...
1. DD-070 / DD-067: 2回目のGodot大形状再制作でも大面の模型感が残ったため、張り出し1個だけを対象にGodot生成版とBlender/手作り専用mesh版を同条件A/Bする。高い根元/低い棚/切れ込み/下面/歩行・遊泳差を維持し、見た目だけの岩へ戻さない。
2. DD-064: 入水直後の構図には大きな差がなく、右側へ寄りたくなる理由は継続課題。「右へ寄る理由→補給後に裂け目発見」の二段階を通常視点で作る。
