...
- 状態: **Phase 1 / 海上開始・上下操作を3サイクル改善・中核レビュー**
...
- 300m試作に海上からの入水、Space浮上、E急降下の酸素コスト、瞬時補給、動く足場と深度別景観を追加。変更した中核のプレイ感を評価する段階。可逆な実装ごとの承認は不要。
...
1. DIVE DIVEのWindows試作を人間がプレイし、上下操作・足場を経由する意味・瞬時補給の遊びを評価する。
