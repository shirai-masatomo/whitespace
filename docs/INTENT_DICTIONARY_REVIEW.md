...
| deferred | 面倒くさい | dismissive-insult | medium (レビュー注意) | generated | hostile | 人ではなく状況への評価の場合もある。 2026-09-05: 対象・関係性によって敵意の有無が変わるため保留。既存「面倒」に一致する表現もある。 |
...
| deferred | きっと大丈夫 | optimistic-reassurance | medium (レビュー注意) | generated | reassurance | 根拠のない楽観と受け取られる場合がある。 2026-09-05: 安心の提供と感情の抑制・根拠のない楽観の区別を相談する。既存「大丈夫」に一致する表現もある。 |
